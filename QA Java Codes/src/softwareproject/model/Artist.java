...
public class Artist {
    ...
    //general cons
    public Artist(String imageUrl, String artistName, String type) {
    ...
    //Spotify cons
    public Artist(String externalUrl, int followersTotal, ArrayList<String> genres, String href, String spotifyId, String imageUrl, String artistName, int popularity, String type) {
